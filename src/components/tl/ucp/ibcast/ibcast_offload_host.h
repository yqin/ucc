...
#ifndef IBCAST_OFFLOAD_HOST_H_
#define IBCAST_OFFLOAD_HOST_H_
...
static int register_ibcast_host_notifications(dpu_offload_ev_sys_t *ev_sys)
{
    int rc;
